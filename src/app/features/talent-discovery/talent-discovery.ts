  ...
  private mockTalents: TalentProfile[] = [
    {
      ...
      bio: 'Creative UI/UX designer with 6+ years of experience in creating beautiful and user-friendly interfaces.',
    ...
    },
    {
      ...
      skills: ['Node.js', 'Python', 'AWS', 'Docker', 'PostgreSQL', 'Redis', 'GraphQL'],
